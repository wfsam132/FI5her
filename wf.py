...
#-----------------[ HASIL-CRACK ]-----------------#
def result():
	cetak(panel(f'[bold white][[bold cyan]01[/][bold white]][/] [bold white]Ok Results [/]\n[bold white][[bold cyan]02[/][bold white]][/] [bold white]cp Results [/]\n[bold white][[bold cyan]03[/][bold white]][/] [bold red]Return[/]',width=90,title=f"[bold white]• [/][bold green]List Menu Cek[/][bold white] •[/]",style=f"bold white"))
	kz = input(f' [+] Select : ')
	if kz in ['2','02']:
